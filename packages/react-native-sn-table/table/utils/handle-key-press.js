...
export const getRowAndColumnCount = (rootElement) => {
  ...
  const columnCount =
    rootElement.getElementsByClassName('sn-table-head-cell').length;
...
export const moveFocus = (
  ...
  const nextCellCoord = arrowKeysNavigation(
    evt,
    rowAndColumnCount,
    cellCoord,
    topAllowedRow,
 ...
 */
export const totalHandleKeyPress = (
  evt,
  rootElement,
  cellCoord,
  setFocusedCellCoord,
...
export const bodyHandleKeyUp = (evt, selectionDispatch) => {
  evt.key === 'Shift' &&
    selectionDispatch({type: SelectionActions.SELECT_MULTI_VALUES});
};
