...
export default function muiSetup(direction) {
  ...
  if (muiConfig.components) {
    ...
    muiConfig.components.MuiTableSortLabel.styleOverrides.root.color =
      'inherit';
    muiConfig.components.MuiTableSortLabel.styleOverrides.root[
      '&.Mui-active'
    ].color = 'inherit';
    muiConfig.components.MuiTableSortLabel.styleOverrides.root[
      '&:hover'
    ].color = 'inherit';
    muiConfig.components.MuiTableRow.styleOverrides.root[
      '&&:hover'
    ...
    muiConfig.components.MuiFormLabel.styleOverrides.root['&.Mui-focused'] = {
      color: 'inherit',
    };
    ...
    muiConfig.components.MuiInputBase.styleOverrides.input.border =
      '1px solid transparent';
    muiConfig.components.MuiOutlinedInput.styleOverrides.input.padding =
      '0px 12px';
    muiConfig.components.MuiNativeSelect.styleOverrides.outlined.border =
      '1px solid transparent';
