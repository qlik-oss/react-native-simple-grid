...
export const StyledIconButton = styled(IconButton, {
  shouldForwardProp: (prop) =>
    prop !== 'disabledCondition' && prop !== 'paginationTheme',
})(({disabledCondition, paginationTheme}) => ({
  color: disabledCondition
    ? paginationTheme.disabledIconColor
    : paginationTheme.iconColor,
...
export const StyledTableBody = styled(TableBody, {
  shouldForwardProp: (prop) =>
    prop !== 'paginationNeeded' && prop !== 'bodyCellStyle',
...
export const StyledTotalsCell = styled(TableCell, {
  shouldForwardProp: (prop) =>
    prop !== 'isTop' && prop !== 'headRowHeight' && prop !== 'totalsStyle',
...
export const StyledTableWrapper = styled(Paper, {
  shouldForwardProp: (prop) =>
    prop !== 'tableTheme' && prop !== 'paginationNeeded',
